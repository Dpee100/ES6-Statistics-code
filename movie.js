...
try {
	const movie1 = new Movie(`Avengers`, 100, `Action Drama`)
	const movie2 = new Movie(`Comando`, 100, `Action Drama`)
	const movie3 = new Movie(`9 tails`, 100, `Action Drama`)
	...
	const Prince = new Customer(`Prince`)
	const Dpee = new Customer(`Dpee`)
	Dpee.rentMovie(`9 tails`).returnMovie(`9 tails`)
	console.log(Prince.rentMovie(`Avengers`).rentMovie(`Comando`).returnMovie(`Avengers`).getRentedMovies())
